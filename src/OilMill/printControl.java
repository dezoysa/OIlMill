...
//                System.out.println("Found");
    ...
    public void printBill(Node node){
        Printer myPrinter = this.findPrinter("EPSON TM-T82-S/A");
    ...
    public void print(List<Product> bill) throws PrintException {
     ...
     //   PrintService printService[] = PrintServiceLookup.lookupPrintServices(DocFlavor.INPUT_STREAM.GIF, pras);
        PrintService service = this.findPrintService("EPSON TM-T82-S/A", printService);
